    ...
    <div class="container">
      <div class="row mt-4">
        ...
        <div class="col-sm-4">
          <div class="card mt-4">
            <div class="card-body">
              <img src="images/header2.jpg" class="d-block img-fluid mb-3" alt="">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <button type="button" class="btn btn-success btn-block text-center text-white mb-4" name="button">Join the Forum</button>
               <a style="text-decoration:none;color:white;" href="Login.php"><button type="button" class="btn btn-danger btn-block text-center text-white mb-4" name="button">Admin Login </button></a>
